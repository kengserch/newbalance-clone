        ...
        <nav className=" container-nav sm:container-fluid  mx-auto z-10 flex justify-between">
            ...
            <div className="flex items-center">
              <a className="text-xl text-black pl-2">
                <img className=" w-12 h-auto" src="https://i.pinimg.com/originals/d5/62/0a/d5620af0e61c3882e0f164cae98f0cc9.png"/>
              </a>
        ...
        <nav className={` top-0 absolute w-full h-[90rem] z-40 bg-white  transition duration-200 ${navbarToggle ? "translate-x-0" : "translate-x-[100%]"} md:hidden `}>
            ...
            <div className="grid grid-cols-2 grid-flow-col">
              ...
              <div className="grid justify-items-end content-center px-5 py-5 sm:px-12">
                <svg onClick={NavToggle} className=" w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
