    ...
    <>
      ...
      <main className='container mx-auto'>
        ...
        <div className='relative lg:mt-[5rem]'>
          ...
          <img className="w-full h-auto lg:hidden" src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw55dd73c5/images/page-designer/2023/october/16005_Comp_A_Mobile.jpg?sw=991&sfrm=jpg"/>
        </div>
        ...
        <div className=" grid grid-cols-2 gap-8 p-3 mt-10 lg:grid-cols-3">
          <div data-aos="fade-up">
            <img src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw34a69c42/images/page-designer/2023/october/16005_Comp_I_Image1.jpg?sw=660&sfrm=jpg"/>
            <p className='font-bold text-md  pt-4'>Gifts for men</p>
          </div>
          <div data-aos="fade-up">
            <img src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dwa68da0e4/images/page-designer/2023/october/16005_Comp_I_Image2.jpg?sw=660&sfrm=jpg"/>
            <p className='font-bold text-md  pt-4'>Gifts for women</p>
          </div>
          <div data-aos="fade-up" className='hidden lg:block'>
            <img src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw32e7e1cf/images/page-designer/2023/october/16005_Comp_I_Image3.jpg?sw=660&sfrm=jpg"/>
        ...
        <div className='grid grid-cols-1 gap-2 md:grid-cols-2'>
          <div data-aos="fade-up" className='p-3'>
            <img className='' src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw5db5c7b9/images/page-designer/2023/october/16005_Comp_E3_Image1.jpg?sw=991&sfrm=jpg" />
          ...
          <div data-aos="fade-up" className='p-3'>
            <img className='' src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dwa671e80d/images/page-designer/2023/october/16005_Comp_E2_Image1.jpg?sw=991&sfrm=jpg" />
        ...
        <div className='p-3 grid grid-cols-1 md:grid-cols-3'>
          <img data-aos="fade-up" className=' mt-4' src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw8b62582c/images/page-designer/2023/october/16005_Comp_R_Image1.jpg" />
          <img data-aos="fade-up" className=' mt-4 pl-3' src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw41d639f2/images/page-designer/2023/october/16005_Comp_R_Image2.jpg" />
          <img data-aos="fade-up" className=' mt-4 pl-3' src="https://www.newbalance.com/dw/image/v2/AAGI_PRD/on/demandware.static/-/Library-Sites-NBUS-NBCA/default/dw19332442/images/page-designer/2023/october/16005_Comp_R_Image3.jpg" />
        </div>
